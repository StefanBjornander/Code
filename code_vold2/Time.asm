...
section .text
 ...
 @6540$isLeapYear:
	; Modulo £temporary2913 year integral4$4#
	mov eax, [rbp + 24]
	xor edx, edx
	idiv dword [@6541integral4$4#]

 @6540$isLeapYear$1:
	; NotEqual 4 £temporary2913 integral4$0#
	cmp edx, 0
	jne @6540$isLeapYear$4

 @6540$isLeapYear$2:
	; Modulo £temporary2915 year integral4$100#
	mov eax, [rbp + 24]
	xor edx, edx
	idiv dword [@6543integral4$100#]

 @6540$isLeapYear$3:
	; NotEqual 6 £temporary2915 integral4$0#
	cmp edx, 0
	jne @6540$isLeapYear$6

 @6540$isLeapYear$4:
	; Modulo £temporary2918 year integral4$400#
	mov eax, [rbp + 24]
	xor edx, edx
	idiv dword [@6545integral4$400#]

 @6540$isLeapYear$5:
	; NotEqual 8 £temporary2918 integral4$0#
	cmp edx, 0
	jne @6540$isLeapYear$8

 @6540$isLeapYear$6:
	; Assign £temporary2921 integral4$1#
	mov ebx, 1
 ...
 @6540$isLeapYear$8:
	; Assign £temporary2921 integral4$0#
	mov ebx, 0
...
section .text
 ...
 time$1:
	; Address £temporary2924 time
	mov rdi, rbp
	add rdi, 32

 time$2:
	; IntegralToIntegral £temporary2925 £temporary2924

 time$3:
	; AssignRegister rdi £temporary2925
 ...
 time$6:
	; Dereference £temporary2927 timePtr 0
	mov rsi, [rbp + 24]

 time$7:
	; Assign £temporary2927 time
	mov rax, [rbp + 32]
	mov [rsi], rax
...
section .text
 ...
 mktime$1:
	; Dereference £temporary2932 tp 0
	mov rsi, [rbp + 24]

 mktime$2:
	; Subtract £temporary2933 £temporary2932.tm_year integral4$69#
	mov eax, [rsi + 20]
	sub eax, 69

 mktime$3:
	; Divide £temporary2934 £temporary2933 integral4$4#
	xor edx, edx
 ...
 mktime$5:
	; Assign leapDays £temporary2935
	mov [rbp + 32], rax

 mktime$6:
	; Dereference £temporary2936 tp 0
	mov rsi, [rbp + 24]

 mktime$7:
	; Subtract £temporary2937 £temporary2936.tm_year integral4$70#
	mov eax, [rsi + 20]
	sub eax, 70

 mktime$8:
	; Multiply £temporary2938 £temporary2937 integral4$365#
	xor edx, edx
	imul dword [@6561integral4$365#]

 mktime$9:
	; IntegralToIntegral £temporary2940 £temporary2938
	mov rbx, 4294967295
	and rax, rbx
	cmp eax, 0
	jge mktime$10
 ...
 mktime$10:
	; Add £temporary2939 £temporary2940 leapDays
	add rax, [rbp + 32]

 mktime$11:
	; Dereference £temporary2941 tp 0
	mov rsi, [rbp + 24]

 mktime$12:
	; IntegralToIntegral £temporary2943 £temporary2941.tm_yday
	mov ebx, [rsi + 28]
	mov rcx, 4294967295
	and rbx, rcx
	cmp ebx, 0
 ...
 mktime$13:
	; Add totalDays £temporary2939 £temporary2943
	add rax, rbx
	mov [rbp + 40], rax

 mktime$14:
	; Multiply £temporary2944 totalDays integral8$86400#
	mov rax, [rbp + 40]
	xor rdx, rdx
 ...
 mktime$15:
	; Dereference £temporary2945 tp 0
	mov rsi, [rbp + 24]

 mktime$16:
	; IntegralToIntegral £temporary2947 £temporary2945.tm_hour
	mov eax, [rsi + 8]
	mov rcx, 4294967295
	and rax, rcx
	cmp eax, 0
 ...
 mktime$17:
	; Multiply £temporary2946 £temporary2947 integral8$3600#
	xor rdx, rdx
	imul qword [@6567integral8$3600#]

 mktime$18:
	; Add £temporary2948 £temporary2944 £temporary2946
	add rbx, rax
 ...
 mktime$20:
	; IntegralToIntegral £temporary2951 £temporary2949.tm_min
	mov eax, [rsi + 4]
	mov rcx, 4294967295
	and rax, rcx
	cmp eax, 0
 ...
 mktime$21:
	; Multiply £temporary2950 £temporary2951 integral8$60#
	xor rdx, rdx
	imul qword [@6569integral8$60#]

 mktime$22:
	; Add £temporary2952 £temporary2948 £temporary2950
	add rbx, rax
 ...
 mktime$24:
	; IntegralToIntegral £temporary2955 £temporary2953.tm_sec
	mov eax, [rsi]
	mov rcx, 4294967295
	and rax, rcx
	cmp eax, 0
 ...
 mktime$25:
	; Add £temporary2954 £temporary2952 £temporary2955
	add rbx, rax
...
section .text
 ...
 gmtime$1:
	; Dereference £temporary2959 timePtr 0
	mov rsi, [rbp + 24]

 gmtime$2:
	; Assign time £temporary2959
	mov rax, [rsi]
	mov [rbp + 32], rax
 ...
 gmtime$5:
	; Divide £temporary2962 secondsOfDay integral8$3600#
	mov rax, [rbp + 40]
	xor rdx, rdx
 ...
 gmtime$7:
	; Assign g_timeStruct.tm_hour £temporary2963
	mov [@6574$g_timeStruct + 8], eax

 gmtime$8:
	; Divide £temporary2964 secondsOfHour integral8$60#
	mov rax, [rbp + 48]
	xor rdx, rdx
 ...
 gmtime$10:
	; Assign g_timeStruct.tm_min £temporary2965
	mov [@6574$g_timeStruct + 4], eax

 gmtime$11:
	; Modulo £temporary2966 secondsOfHour integral8$60#
	mov rax, [rbp + 48]
	xor rdx, rdx
 ...
 gmtime$13:
	; Assign g_timeStruct.tm_sec £temporary2967
 ...
 gmtime$16:
	; Add £temporary2970 totalDays integral8$4#
	mov rax, [rbp + 56]
	add rax, 4

 gmtime$17:
	; IntegralToIntegral £temporary2971 £temporary2970
	cmp rax, 0
	jge gmtime$18
	neg rax
	neg eax
 ...
 gmtime$18:
	; Assign g_timeStruct.tm_wday £temporary2971
 ...
 gmtime$20:
	; Subtract £temporary2972 totalDays integral8$3#
	mov rax, [rbp + 56]
	sub rax, 3

 gmtime$21:
	; Modulo £temporary2973 £temporary2972 integral8$7#
	xor rdx, rdx
 ...
 gmtime$23:
	; Assign g_timeStruct.tm_wday £temporary2974
	mov [@6574$g_timeStruct + 24], edx

 gmtime$24:
	; Divide £temporary2977 totalDays integral8$365#
	mov rax, [rbp + 56]
	xor rdx, rdx
	idiv qword [@6607integral8$365#]

 gmtime$25:
	; Add £temporary2978 £temporary2977 integral8$1970#
	add rax, 1970

 gmtime$26:
	; IntegralToIntegral £temporary2979 £temporary2978
	cmp rax, 0
	jge gmtime$27
	neg rax
	neg eax
 ...
 gmtime$27:
	; Assign year £temporary2979
	mov [rbp + 64], eax

 gmtime$28:
	; Subtract £temporary2980 year integral4$1969#
	mov eax, [rbp + 64]
	sub eax, 1969

 gmtime$29:
	; Divide leapDays £temporary2980 integral4$4#
	xor edx, edx
 ...
 gmtime$31:
	; IntegralToIntegral £temporary2984 leapDays
	mov eax, [rbp + 68]
	mov rbx, 4294967295
	and rax, rbx
	cmp eax, 0
 ...
 gmtime$32:
	; Subtract totalDays totalDays £temporary2984
	sub [rbp + 56], rax
 ...
 gmtime$40:
	; Equal 43 £temporary2987 integral4$0#
	cmp ebx, 0
	je gmtime$43
 ...
 gmtime$45:
	; IntegralToIntegral £temporary2996 totalDays
	mov rax, [rbp + 56]
	cmp rax, 0
	jge gmtime$46
	neg rax
 ...
 gmtime$46:
	; Assign g_timeStruct.tm_yday £temporary2996
 ...
 gmtime$53:
	; Equal 56 £temporary2997 integral4$0#
	cmp ebx, 0
	je gmtime$56

 gmtime$54:
	; Assign £temporary2999 integral4$29#
	mov eax, 29
 ...
 gmtime$56:
	; Assign £temporary2999 integral4$28#
	mov eax, 28

 gmtime$57:
	; Assign daysOfMonths[1] £temporary2999
	mov [rbp + 76], eax
 ...
 gmtime$69:
	; Multiply £temporary3012 month integral4$4#
	mov eax, [rbp + 120]
	xor edx, edx
	imul dword [@6643integral4$4#]

 gmtime$70:
	; IntegralToIntegral £temporary3013 £temporary3012
	mov rbx, 4294967295
	and rax, rbx

 gmtime$71:
	; Add £temporary3014 daysOfMonths £temporary3013
	mov rsi, rbp
	add rsi, 72
	add rsi, rax

 gmtime$72:
	; Dereference £temporary3015 £temporary3014 0

 gmtime$73:
	; IntegralToIntegral £temporary3016 £temporary3015
	mov eax, [rsi]
	mov rbx, 4294967295
	and rax, rbx
	cmp eax, 0
 ...
 gmtime$74:
	; LessThan 84 totalDays £temporary3016
	cmp [rbp + 56], rax
	jl gmtime$84

 gmtime$75:
	; Assign £temporary3018 month
	mov eax, [rbp + 120]
 ...
 gmtime$77:
	; Multiply £temporary3020 £temporary3018 integral4$4#
	xor edx, edx
 ...
 gmtime$79:
	; Add £temporary3022 daysOfMonths £temporary3021
	mov rsi, rbp
	add rsi, 72
	add rsi, rax
 ...
 gmtime$81:
	; IntegralToIntegral £temporary3025 £temporary3023
	mov eax, [rsi]
	mov rbx, 4294967295
	and rax, rbx
	cmp eax, 0
 ...
 gmtime$82:
	; Subtract totalDays totalDays £temporary3025
	sub [rbp + 56], rax
 ...
 gmtime$85:
	; Add £temporary3026 totalDays integral8$1#
	mov rax, [rbp + 56]
	inc rax
 ...
 gmtime$87:
	; Assign g_timeStruct.tm_mday £temporary3027
...
section .text
 ...
 localtime$5:
	; Assign tmPtr £temporary3030
	mov [rbp + 32], rbx

 localtime$6:
	; Dereference £temporary3031 timePtr 0
	mov rsi, [rbp + 24]

 localtime$7:
	; Assign t £temporary3031
	mov rax, [rsi]
	mov [rbp + 40], rax
 ...
 localtime$12:
	; Assign localeConvPtr £temporary3032
	mov [rbp + 48], rbx
 ...
 localtime$14:
	; Dereference £temporary3034 tmPtr 0
	mov rsi, [rbp + 32]

 localtime$15:
	; NotEqual 19 £temporary3034.tm_isdst integral4$1#
	cmp dword [rsi + 32], 1
	jne localtime$19

 localtime$16:
	; Dereference £temporary3036 localeConvPtr 0
	mov rsi, [rbp + 48]

 localtime$17:
	; Assign £temporary3038 £temporary3036.summerTimeZone
	mov eax, [rsi]
 ...
 localtime$20:
	; Assign £temporary3038 £temporary3037.winterTimeZone
	mov eax, [rsi + 4]

 localtime$21:
	; Assign timeZone £temporary3038
	mov [rbp + 56], eax

 localtime$22:
	; IntegralToIntegral £temporary3040 timeZone
	mov eax, [rbp + 56]
	mov rbx, 4294967295
	and rax, rbx
	cmp eax, 0
 ...
 localtime$23:
	; Multiply £temporary3039 £temporary3040 integral8$3600#
	xor rdx, rdx
	imul qword [@6668integral8$3600#]

 localtime$24:
	; Add t t £temporary3039
	add [rbp + 40], rax
 ...
 localtime$26:
	; Address £temporary3044 t
	mov rsi, rbp
	add rsi, 40

 localtime$27:
	; Parameter 80 pointer £temporary3044
	mov [rbp + 80], rsi
 ...
 localtime$30:
	; GetReturnValue £temporary3045

 localtime$31:
	; SetReturnValue

 localtime$32:
	; Return £temporary3045
	mov rax, [rbp]
	mov rdi, [rbp + 16]
	mov rbp, [rbp + 8]
	jmp rax
...
section .text
 ...
 difftime:
	; Subtract £temporary3047 time2 time1
	mov rax, [rbp + 32]
	sub rax, [rbp + 24]

 difftime$1:
	; IntegralToFloating £temporary3048 £temporary3047
...
section .text
 ...
 asctime$2:
	; Dereference £temporary3050 localeConvPtr 0
	mov rsi, [rbp + 32]

 asctime$3:
	; Equal 7 £temporary3050.shortDayList integral8$0#
	cmp qword [rsi + 8], 0
	je asctime$7

 asctime$4:
	; Dereference £temporary3053 localeConvPtr 0
	mov rsi, [rbp + 32]

 asctime$5:
	; Assign shortDayList £temporary3053.shortDayList
	mov rax, [rsi + 8]
	mov [rbp + 40], rax
 ...
 asctime$9:
	; Dereference £temporary3057 localeConvPtr 0
	mov rsi, [rbp + 32]

 asctime$10:
	; Equal 14 £temporary3057.shortMonthList integral8$0#
	cmp qword [rsi + 24], 0
	je asctime$14

 asctime$11:
	; Dereference £temporary3060 localeConvPtr 0
	mov rsi, [rbp + 32]

 asctime$12:
	; Assign shortMonthList £temporary3060.shortMonthList
	mov rax, [rsi + 24]
	mov [rbp + 48], rax
 ...
 asctime$18:
	; Dereference £temporary3063 tp 0
	mov rsi, [rbp + 24]

 asctime$19:
	; Multiply £temporary3064 £temporary3063.tm_wday integral4$8#
	mov eax, [rsi + 24]
	xor edx, edx
	imul dword [@6738integral4$8#]

 asctime$20:
	; IntegralToIntegral £temporary3065 £temporary3064
	mov rbx, 4294967295
	and rax, rbx

 asctime$21:
	; Add £temporary3066 shortDayList £temporary3065
	mov rsi, [rbp + 40]
	add rsi, rax
 ...
 asctime$23:
	; Parameter 96 pointer £temporary3067
	mov rax, [rsi]
	mov [rbp + 96], rax

 asctime$24:
	; Dereference £temporary3068 tp 0
	mov rsi, [rbp + 24]

 asctime$25:
	; Multiply £temporary3069 £temporary3068.tm_mon integral4$8#
	mov eax, [rsi + 16]
	xor edx, edx
	imul dword [@6740integral4$8#]

 asctime$26:
	; IntegralToIntegral £temporary3070 £temporary3069
	mov rbx, 4294967295
	and rax, rbx

 asctime$27:
	; Add £temporary3071 shortMonthList £temporary3070
	mov rsi, [rbp + 48]
	add rsi, rax

 asctime$28:
	; Dereference £temporary3072 £temporary3071 0

 asctime$29:
	; Parameter 104 pointer £temporary3072
	mov rax, [rsi]
	mov [rbp + 104], rax

 asctime$30:
	; Dereference £temporary3073 tp 0
	mov rsi, [rbp + 24]

 asctime$31:
	; Parameter 112 signed int £temporary3073.tm_mday
	mov eax, [rsi + 12]
	mov [rbp + 112], eax
 ...
 asctime$33:
	; Parameter 116 signed int £temporary3074.tm_hour
	mov eax, [rsi + 8]
	mov [rbp + 116], eax
 ...
 asctime$35:
	; Parameter 120 signed int £temporary3075.tm_min
	mov eax, [rsi + 4]
	mov [rbp + 120], eax
 ...
 asctime$37:
	; Parameter 124 signed int £temporary3076.tm_sec
	mov eax, [rsi]
	mov [rbp + 124], eax
 ...
 asctime$39:
	; Add £temporary3078 £temporary3077.tm_year integral4$1900#
	mov eax, [rsi + 20]
	add eax, 1900

 asctime$40:
	; Parameter 128 signed int £temporary3078
	mov [rbp + 128], eax
...
section .text
 ...
 ctime$6:
	; Parameter 56 pointer £temporary3080
	mov [rbp + 56], rbx
...
section .text
 ...
 getWeekNumber$1:
	; Subtract £temporary3083 £temporary3082.tm_year integral4$69#
	mov eax, [rsi + 20]
	sub eax, 69

 getWeekNumber$2:
	; Divide £temporary3084 £temporary3083 integral4$4#
	xor edx, edx
	idiv dword [@6762integral4$4#]

 getWeekNumber$3:
	; IntegralToIntegral £temporary3085 £temporary3084
	mov rbx, 4294967295
	and rax, rbx
	cmp eax, 0
	jge getWeekNumber$4
 ...
 getWeekNumber$6:
	; Subtract £temporary3087 £temporary3086.tm_year integral4$70#
	mov eax, [rsi + 20]
	sub eax, 70

 getWeekNumber$7:
	; Multiply £temporary3088 £temporary3087 integral4$365#
	xor edx, edx
 ...
 getWeekNumber$9:
	; Add £temporary3089 £temporary3090 leapDays
	add rax, [rbp + 32]
 ...
 getWeekNumber$11:
	; Assign totalDays £temporary3091
	mov [rbp + 40], eax
 ...
 getWeekNumber$15:
	; Subtract £temporary3094 totalDays integral4$3#
	mov eax, [rbp + 40]
	sub eax, 3

 getWeekNumber$16:
	; Modulo weekDayJanuaryFirst £temporary3094 integral4$7#
	xor edx, edx
 ...
 getWeekNumber$18:
	; Dereference £temporary3099 tp 0
	mov rsi, [rbp + 24]

 getWeekNumber$19:
	; GreaterThanEqual 22 £temporary3099.tm_yday firstWeekSize
	mov eax, [rbp + 48]
	cmp [rsi + 28], eax
 ...
 getWeekNumber$22:
	; Dereference £temporary3101 tp 0
	mov rsi, [rbp + 24]

 getWeekNumber$23:
	; Subtract £temporary3102 £temporary3101.tm_yday firstWeekSize
	mov eax, [rsi + 28]
	sub eax, [rbp + 48]

 getWeekNumber$24:
	; Divide £temporary3103 £temporary3102 integral4$7#
	xor edx, edx
	idiv dword [@6778integral4$7#]

 getWeekNumber$25:
	; Add £temporary3104 £temporary3103 integral4$1#
	inc eax
...
section .text
 ...
 strftime$3:
	; GetReturnValue £temporary3107

 strftime$4:
	; Assign localeConvPtr £temporary3107
	mov [rbp + 52], rbx
 ...
 strftime$6:
	; Dereference £temporary3109 localeConvPtr 0
	mov rsi, [rbp + 52]

 strftime$7:
	; Equal 11 £temporary3109.shortDayList integral8$0#
	cmp qword [rsi + 8], 0
	je strftime$11

 strftime$8:
	; Dereference £temporary3112 localeConvPtr 0
	mov rsi, [rbp + 52]

 strftime$9:
	; Assign shortDayList £temporary3112.shortDayList
	mov rax, [rsi + 8]
	mov [rbp + 60], rax
 ...
 strftime$13:
	; Dereference £temporary3116 localeConvPtr 0
	mov rsi, [rbp + 52]

 strftime$14:
	; Equal 18 £temporary3116.longDayList integral8$0#
	cmp qword [rsi + 16], 0
	je strftime$18

 strftime$15:
	; Dereference £temporary3119 localeConvPtr 0
	mov rsi, [rbp + 52]

 strftime$16:
	; Assign longDayList £temporary3119.longDayList
	mov rax, [rsi + 16]
	mov [rbp + 76], rax
 ...
 strftime$21:
	; Equal 25 £temporary3123.shortMonthList integral8$0#
	cmp qword [rsi + 24], 0
	je strftime$25

 strftime$22:
	; Dereference £temporary3126 localeConvPtr 0
	mov rsi, [rbp + 52]

 strftime$23:
	; Assign shortMonthList £temporary3126.shortMonthList
	mov rax, [rsi + 24]
	mov [rbp + 68], rax
 ...
 strftime$28:
	; Equal 32 £temporary3130.longMonthList integral8$0#
	cmp qword [rsi + 32], 0
	je strftime$32

 strftime$29:
	; Dereference £temporary3133 localeConvPtr 0
	mov rsi, [rbp + 52]

 strftime$30:
	; Assign longMonthList £temporary3133.longMonthList
	mov rax, [rsi + 32]
	mov [rbp + 84], rax
 ...
 strftime$42:
	; GetReturnValue £temporary3137

 strftime$43:
	; Assign weekNumberStartSunday £temporary3137
	mov [rbp + 96], ebx
 ...
 strftime$45:
	; Dereference £temporary3138 tp 0
	mov rsi, [rbp + 44]

 strftime$46:
	; NotEqual 48 £temporary3138.tm_mday integral4$0#
	cmp dword [rsi + 12], 0
	jne strftime$48
 ...
 strftime$50:
	; Add £temporary3144 format £temporary3143
	mov rsi, [rbp + 36]
	add rsi, rax

 strftime$51:
	; Dereference £temporary3145 £temporary3144 0

 strftime$52:
	; Equal 330 £temporary3145 integral1$0#
	cmp byte [rsi], 0
	je strftime$330
 ...
 strftime$54:
	; Add £temporary3149 format £temporary3148
	mov rsi, [rbp + 36]
	add rsi, rax

 strftime$55:
	; Dereference £temporary3150 £temporary3149 0

 strftime$56:
	; NotEqual 304 £temporary3150 integral1$37#
	cmp byte [rsi], 37
	jne strftime$304
 ...
 strftime$59:
	; Add £temporary3154 format £temporary3153
	mov rsi, [rbp + 36]
	add rsi, rax

 strftime$60:
	; Dereference £temporary3155 £temporary3154 0

 strftime$61:
	; Case 85 £temporary3155 integral1$97#
	mov al, [rsi]
	cmp al, 97
	je strftime$85

 strftime$62:
	; Case 96 £temporary3155 integral1$65#
	cmp al, 65
	je strftime$96

 strftime$63:
	; Case 107 £temporary3155 integral1$98#
	cmp al, 98
	je strftime$107

 strftime$64:
	; Case 118 £temporary3155 integral1$66#
	cmp al, 66
	je strftime$118

 strftime$65:
	; Case 129 £temporary3155 integral1$99#
	cmp al, 99
	je strftime$129

 strftime$66:
	; Case 149 £temporary3155 integral1$100#
	cmp al, 100
	je strftime$149

 strftime$67:
	; Case 157 £temporary3155 integral1$72#
	cmp al, 72
	je strftime$157

 strftime$68:
	; Case 165 £temporary3155 integral1$73#
	cmp al, 73
	je strftime$165

 strftime$69:
	; Case 174 £temporary3155 integral1$106#
	cmp al, 106
	je strftime$174

 strftime$70:
	; Case 182 £temporary3155 integral1$109#
	cmp al, 109
	je strftime$182

 strftime$71:
	; Case 191 £temporary3155 integral1$77#
	cmp al, 77
	je strftime$191

 strftime$72:
	; Case 199 £temporary3155 integral1$112#
	cmp al, 112
	je strftime$199

 strftime$73:
	; Case 210 £temporary3155 integral1$83#
	cmp al, 83
	je strftime$210

 strftime$74:
	; Case 218 £temporary3155 integral1$85#
	cmp al, 85
	je strftime$218

 strftime$75:
	; Case 225 £temporary3155 integral1$119#
	cmp al, 119
	je strftime$225

 strftime$76:
	; Case 233 £temporary3155 integral1$87#
	cmp al, 87
	je strftime$233

 strftime$77:
	; Case 240 £temporary3155 integral1$120#
	cmp al, 120
	je strftime$240

 strftime$78:
	; Case 252 £temporary3155 integral1$88#
	cmp al, 88
	je strftime$252

 strftime$79:
	; Case 264 £temporary3155 integral1$121#
	cmp al, 121
	je strftime$264

 strftime$80:
	; Case 273 £temporary3155 integral1$89#
	cmp al, 89
	je strftime$273

 strftime$81:
	; Case 282 £temporary3155 integral1$90#
	cmp al, 90
	je strftime$282

 strftime$82:
	; Case 293 £temporary3155 integral1$37#
	cmp al, 37
	je strftime$293

 strftime$83:
	; CaseEnd £temporary3155
 ...
 strftime$88:
	; Multiply £temporary3157 £temporary3156.tm_wday integral4$8#
	mov eax, [rsi + 24]
	xor edx, edx
 ...
 strftime$90:
	; Add £temporary3159 shortDayList £temporary3158
	mov rsi, [rbp + 60]
	add rsi, rax

 strftime$91:
	; Dereference £temporary3160 £temporary3159 0

 strftime$92:
	; Parameter 156 pointer £temporary3160
	mov rax, [rsi]
	mov [rbp + 156], rax
 ...
 strftime$98:
	; Dereference £temporary3162 tp 0
	mov rsi, [rbp + 44]

 strftime$99:
	; Multiply £temporary3163 £temporary3162.tm_wday integral4$8#
	mov eax, [rsi + 24]
	xor edx, edx
	imul dword [@6835integral4$8#]

 strftime$100:
	; IntegralToIntegral £temporary3164 £temporary3163
	mov rbx, 4294967295
	and rax, rbx

 strftime$101:
	; Add £temporary3165 longDayList £temporary3164
	mov rsi, [rbp + 76]
	add rsi, rax

 strftime$102:
	; Dereference £temporary3166 £temporary3165 0

 strftime$103:
	; Parameter 156 pointer £temporary3166
	mov rax, [rsi]
	mov [rbp + 156], rax
 ...
 strftime$109:
	; Dereference £temporary3168 tp 0
	mov rsi, [rbp + 44]

 strftime$110:
	; Multiply £temporary3169 £temporary3168.tm_mon integral4$8#
	mov eax, [rsi + 16]
	xor edx, edx
	imul dword [@6839integral4$8#]

 strftime$111:
	; IntegralToIntegral £temporary3170 £temporary3169
	mov rbx, 4294967295
	and rax, rbx

 strftime$112:
	; Add £temporary3171 shortMonthList £temporary3170
	mov rsi, [rbp + 68]
	add rsi, rax

 strftime$113:
	; Dereference £temporary3172 £temporary3171 0

 strftime$114:
	; Parameter 156 pointer £temporary3172
	mov rax, [rsi]
	mov [rbp + 156], rax
 ...
 strftime$121:
	; Multiply £temporary3175 £temporary3174.tm_mon integral4$8#
	mov eax, [rsi + 16]
	xor edx, edx
 ...
 strftime$123:
	; Add £temporary3177 longMonthList £temporary3176
	mov rsi, [rbp + 84]
	add rsi, rax
 ...
 strftime$133:
	; Add £temporary3181 £temporary3180.tm_year integral4$1900#
	mov eax, [rsi + 20]
	add eax, 1900

 strftime$134:
	; Parameter 164 signed int £temporary3181
	mov [rbp + 164], eax

 strftime$135:
	; Dereference £temporary3182 tp 0
	mov rsi, [rbp + 44]

 strftime$136:
	; Add £temporary3183 £temporary3182.tm_mon integral4$1#
	mov eax, [rsi + 16]
	inc eax

 strftime$137:
	; Parameter 168 signed int £temporary3183
	mov [rbp + 168], eax

 strftime$138:
	; Dereference £temporary3184 tp 0
	mov rsi, [rbp + 44]

 strftime$139:
	; Parameter 172 signed int £temporary3184.tm_mday
	mov eax, [rsi + 12]
	mov [rbp + 172], eax
 ...
 strftime$141:
	; Parameter 176 signed int £temporary3185.tm_hour
	mov eax, [rsi + 8]
	mov [rbp + 176], eax
 ...
 strftime$143:
	; Parameter 180 signed int £temporary3186.tm_min
	mov eax, [rsi + 4]
	mov [rbp + 180], eax
 ...
 strftime$145:
	; Parameter 184 signed int £temporary3187.tm_sec
	mov eax, [rsi]
	mov [rbp + 184], eax
 ...
 strftime$152:
	; Dereference £temporary3189 tp 0
	mov rsi, [rbp + 44]

 strftime$153:
	; Parameter 164 signed int £temporary3189.tm_mday
	mov eax, [rsi + 12]
	mov [rbp + 164], eax
 ...
 strftime$160:
	; Dereference £temporary3191 tp 0
	mov rsi, [rbp + 44]

 strftime$161:
	; Parameter 164 signed int £temporary3191.tm_hour
	mov eax, [rsi + 8]
	mov [rbp + 164], eax
 ...
 strftime$169:
	; Modulo £temporary3194 £temporary3193.tm_hour integral4$12#
	mov eax, [rsi + 8]
	xor edx, edx
	idiv dword [@6867integral4$12#]

 strftime$170:
	; Parameter 164 signed int £temporary3194
	mov [rbp + 164], edx
 ...
 strftime$177:
	; Dereference £temporary3196 tp 0
	mov rsi, [rbp + 44]

 strftime$178:
	; Parameter 164 signed int £temporary3196.tm_yday
	mov eax, [rsi + 28]
	mov [rbp + 164], eax
 ...
 strftime$186:
	; Add £temporary3199 £temporary3198.tm_mon integral4$1#
	mov eax, [rsi + 16]
	inc eax
 ...
 strftime$195:
	; Parameter 164 signed int £temporary3201.tm_min
	mov eax, [rsi + 4]
	mov [rbp + 164], eax
 ...
 strftime$203:
	; Assign £temporary3204 string_AM#
 ...
 strftime$205:
	; Assign £temporary3204 string_PM#
	mov rax, @6885string_PM#

 strftime$206:
	; Parameter 164 string £temporary3204
	mov [rbp + 164], rax
 ...
 strftime$213:
	; Dereference £temporary3206 tp 0
	mov rsi, [rbp + 44]

 strftime$214:
	; Parameter 164 signed int £temporary3206.tm_sec
	mov eax, [rsi]
	mov [rbp + 164], eax
 ...
 strftime$229:
	; Parameter 164 signed int £temporary3209.tm_wday
	mov eax, [rsi + 24]
	mov [rbp + 164], eax
 ...
 strftime$243:
	; Dereference £temporary3212 tp 0
	mov rsi, [rbp + 44]

 strftime$244:
	; Parameter 164 signed int £temporary3212.tm_hour
	mov eax, [rsi + 8]
	mov [rbp + 164], eax
 ...
 strftime$246:
	; Parameter 168 signed int £temporary3213.tm_min
	mov eax, [rsi + 4]
	mov [rbp + 168], eax
 ...
 strftime$248:
	; Parameter 172 signed int £temporary3214.tm_sec
	mov eax, [rsi]
	mov [rbp + 172], eax
 ...
 strftime$256:
	; Parameter 164 signed int £temporary3216.tm_hour
	mov eax, [rsi + 8]
	mov [rbp + 164], eax
 ...
 strftime$258:
	; Parameter 168 signed int £temporary3217.tm_min
	mov eax, [rsi + 4]
	mov [rbp + 168], eax
 ...
 strftime$260:
	; Parameter 172 signed int £temporary3218.tm_sec
	mov eax, [rsi]
	mov [rbp + 172], eax
 ...
 strftime$267:
	; Dereference £temporary3220 tp 0
	mov rsi, [rbp + 44]

 strftime$268:
	; Modulo £temporary3221 £temporary3220.tm_year integral4$100#
	mov eax, [rsi + 20]
	xor edx, edx
	idiv dword [@6917integral4$100#]

 strftime$269:
	; Parameter 164 signed int £temporary3221
	mov [rbp + 164], edx
 ...
 strftime$276:
	; Dereference £temporary3223 tp 0
	mov rsi, [rbp + 44]

 strftime$277:
	; Add £temporary3224 £temporary3223.tm_year integral4$1900#
	mov eax, [rsi + 20]
	add eax, 1900

 strftime$278:
	; Parameter 164 signed int £temporary3224
	mov [rbp + 164], eax
 ...
 strftime$285:
	; Equal 288 £temporary3226.tm_isdst integral4$0#
	cmp dword [rsi + 32], 0
	je strftime$288

 strftime$286:
	; Assign £temporary3228 string_summer#
 ...
 strftime$288:
	; Assign £temporary3228 string_winter#
	mov rax, @6927string_winter#

 strftime$289:
	; Parameter 156 string £temporary3228
	mov [rbp + 156], rax
 ...
 strftime$304:
	; Dereference £temporary3233 £temporary3232 0
	mov rsi, rbp
	add rsi, 104
 ...
 strftime$306:
	; Add £temporary3235 format £temporary3234
	mov rdi, [rbp + 36]
	add rdi, rax

 strftime$307:
	; Dereference £temporary3236 £temporary3235 0

 strftime$308:
	; Assign £temporary3233 £temporary3236
	mov al, [rdi]
	mov [rsi], al

 strftime$309:
	; Dereference £temporary3238 £temporary3237 0
	mov rsi, rbp
	add rsi, 104

 strftime$310:
	; Assign £temporary3238 integral1$0#
	mov byte [rsi + 1], 0
 ...
 strftime$321:
	; Add £temporary3243 £temporary3241 £temporary3242
	add ebx, eax

 strftime$322:
	; GreaterThanEqual 330 £temporary3243 maxSize
	cmp ebx, [rbp + 32]
	jge strftime$330
