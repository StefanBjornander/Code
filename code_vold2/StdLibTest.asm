...
section .text
 ...
 compare:
	; IntegralToIntegral £temporary4756 valuePtr1
	mov rsi, [rbp + 24]

 compare$1:
	; Dereference £temporary4757 £temporary4756 0

 compare$2:
	; Assign intValue1 £temporary4757
	mov eax, [rsi]
	mov [rbp + 40], eax

 compare$3:
	; IntegralToIntegral £temporary4758 valuePtr2
	mov rsi, [rbp + 32]

 compare$4:
	; Dereference £temporary4759 £temporary4758 0

 compare$5:
	; Assign intValue2 £temporary4759
	mov eax, [rsi]
	mov [rbp + 44], eax
 ...
 compare$7:
	; Assign £temporary4763 integral4$minus1#
	mov ebx, -1
 ...
 compare$10:
	; Assign £temporary4763 integral4$0#
	mov ebx, 0
 ...
 compare$12:
	; Assign £temporary4763 integral4$1#
	mov ebx, 1
...
section .text
 ...
 reverse_compare:
	; IntegralToIntegral £temporary4764 valuePtr1
	mov rsi, [rbp + 24]

 reverse_compare$1:
	; Dereference £temporary4765 £temporary4764 0

 reverse_compare$2:
	; Assign intValue1 £temporary4765
	mov eax, [rsi]
	mov [rbp + 40], eax

 reverse_compare$3:
	; IntegralToIntegral £temporary4766 valuePtr2
	mov rsi, [rbp + 32]

 reverse_compare$4:
	; Dereference £temporary4767 £temporary4766 0

 reverse_compare$5:
	; Assign intValue2 £temporary4767
	mov eax, [rsi]
	mov [rbp + 44], eax
 ...
 reverse_compare$7:
	; Assign £temporary4771 integral4$1#
	mov ebx, 1
 ...
 reverse_compare$10:
	; Assign £temporary4771 integral4$0#
	mov ebx, 0
 ...
 reverse_compare$12:
	; Assign £temporary4771 integral4$minus1#
	mov ebx, -1
...
section .text
 ...
 qtest$2:
	; IntegralToIntegral £temporary4786 f
	mov rax, [rbp + 24]

 qtest$3:
	; Parameter 64 unsigned int £temporary4786
	mov [rbp + 64], eax
...
section .text
 ...
 stdlib_testZ$2:
	; IntegralToIntegral £temporary4789 hello
	mov rax, hello

 stdlib_testZ$3:
	; Parameter 56 unsigned int £temporary4789
	mov [rbp + 56], eax
...
section .text
 ...
 stdlib_test$6:
	; GetReturnValue £temporary4793

 stdlib_test$7:
	; Parameter 64 double £temporary4793
	fstp qword [rbp + 64]
 ...
 stdlib_test$14:
	; Address £temporary4795 p
	mov rsi, rbp
	add rsi, 24

 stdlib_test$15:
	; Parameter 96 pointer £temporary4795
	mov [rbp + 96], rsi
 ...
 stdlib_test$19:
	; Parameter 64 double £temporary4796
	fstp qword [rbp + 64]
 ...
 stdlib_test$30:
	; Parameter 56 pointer £temporary4798
	mov [rbp + 56], rbx
 ...
 stdlib_test$47:
	; GetReturnValue £temporary4802

 stdlib_test$48:
	; Parameter 56 signed int £temporary4802
	mov [rbp + 56], ebx
 ...
 stdlib_test$54:
	; Parameter 60 signed int £temporary4803
	mov [rbp + 60], ebx
 ...
 stdlib_test$64:
	; Parameter 56 signed long int £temporary4805
	mov [rbp + 56], rbx
 ...
 stdlib_test$70:
	; Parameter 64 signed long int £temporary4806
	mov [rbp + 64], rbx
 ...
 stdlib_test$78:
	; GetReturnValue £temporary4808

 stdlib_test$79:
	; AssignInitSize i £temporary4808
	mov rsi, rbp
	add rsi, 24
	mov al, 8

 stdlib_test$80:
	; Assign i £temporary4808
	mov ah, [rbx]
	mov [rsi], ah
	inc rbx
	inc rsi
 ...
 stdlib_test$93:
	; AssignInitSize j £temporary4811
	mov rsi, rbp
	add rsi, 32
	mov al, 8

 stdlib_test$94:
	; Assign j £temporary4811
	mov ah, [rbx]
	mov [rsi], ah
	inc rbx
	inc rsi
 ...
 stdlib_test$106:
	; GetReturnValue £temporary4814

 stdlib_test$107:
	; AssignInitSize li £temporary4814
	mov rsi, rbp
	add rsi, 24
	mov al, 16

 stdlib_test$108:
	; Assign li £temporary4814
	mov ah, [rbx]
	mov [rsi], ah
	inc rbx
	inc rsi
 ...
 stdlib_test$121:
	; AssignInitSize lj £temporary4817
	mov rsi, rbp
	add rsi, 40
	mov al, 16

 stdlib_test$122:
	; Assign lj £temporary4817
	mov ah, [rbx]
	mov [rsi], ah
	inc rbx
	inc rsi
 ...
 stdlib_test$142:
	; Multiply £temporary4829 index integral4$4#
	mov eax, [rbp + 44]
	xor edx, edx
	imul dword [@12357integral4$4#]

 stdlib_test$143:
	; IntegralToIntegral £temporary4830 £temporary4829
	mov rbx, 4294967295
	and rax, rbx

 stdlib_test$144:
	; Add £temporary4831 list £temporary4830
	mov rsi, rbp
	add rsi, 24
	add rsi, rax

 stdlib_test$145:
	; Dereference £temporary4832 £temporary4831 0

 stdlib_test$146:
	; Parameter 80 signed int £temporary4832
	mov eax, [rsi]
	mov [rbp + 80], eax
 ...
 stdlib_test$166:
	; Multiply £temporary4840 index integral4$4#
	mov eax, [rbp + 44]
	xor edx, edx
	imul dword [@12368integral4$4#]

 stdlib_test$167:
	; IntegralToIntegral £temporary4841 £temporary4840
	mov rbx, 4294967295
	and rax, rbx

 stdlib_test$168:
	; Add £temporary4842 list £temporary4841
	mov rsi, rbp
	add rsi, 24
	add rsi, rax

 stdlib_test$169:
	; Dereference £temporary4843 £temporary4842 0

 stdlib_test$170:
	; Parameter 80 signed int £temporary4843
	mov eax, [rsi]
	mov [rbp + 80], eax
 ...
 stdlib_test$190:
	; Multiply £temporary4851 index integral4$4#
	mov eax, [rbp + 44]
	xor edx, edx
	imul dword [@12379integral4$4#]

 stdlib_test$191:
	; IntegralToIntegral £temporary4852 £temporary4851
	mov rbx, 4294967295
	and rax, rbx

 stdlib_test$192:
	; Add £temporary4853 list £temporary4852
	mov rsi, rbp
	add rsi, 24
	add rsi, rax

 stdlib_test$193:
	; Dereference £temporary4854 £temporary4853 0

 stdlib_test$194:
	; Parameter 80 signed int £temporary4854
	mov eax, [rsi]
	mov [rbp + 80], eax
 ...
 stdlib_test$214:
	; Multiply £temporary4862 index integral4$4#
	mov eax, [rbp + 44]
	xor edx, edx
	imul dword [@12390integral4$4#]

 stdlib_test$215:
	; IntegralToIntegral £temporary4863 £temporary4862
	mov rbx, 4294967295
	and rax, rbx

 stdlib_test$216:
	; Add £temporary4864 list £temporary4863
	mov rsi, rbp
	add rsi, 24
	add rsi, rax

 stdlib_test$217:
	; Dereference £temporary4865 £temporary4864 0

 stdlib_test$218:
	; Parameter 80 signed int £temporary4865
	mov eax, [rsi]
	mov [rbp + 80], eax
 ...
 stdlib_test$230:
	; Address £temporary4870 key
	mov rsi, rbp
	add rsi, 44

 stdlib_test$231:
	; Parameter 72 pointer £temporary4870
	mov [rbp + 72], rsi
 ...
 stdlib_test$238:
	; GetReturnValue £temporary4873

 stdlib_test$239:
	; IntegralToIntegral £temporary4874 £temporary4873

 stdlib_test$240:
	; Assign p £temporary4874
	mov [rbp + 48], rbx
 ...
 stdlib_test$242:
	; Subtract £temporary4876 p list
	mov rax, [rbp + 48]
	sub rax, rbp
	sub rax, 24

 stdlib_test$243:
	; IntegralToIntegral £temporary4877 £temporary4876

 stdlib_test$244:
	; Divide £temporary4879 £temporary4877 integral4$4#
	xor edx, edx
 ...
 stdlib_test$246:
	; Assign £temporary4879 integral4$minus1#
	mov eax, -1

 stdlib_test$247:
	; Assign index £temporary4879
	mov [rbp + 56], eax
