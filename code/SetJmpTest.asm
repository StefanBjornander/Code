...
@9343string_Please20input20a20value3A20#:
...
@9347string_12E0202F2025f203D2025f0A#:
...
section .text
 ...
 @9340$main$1:
	...
	mov qword [rbp + 64], @9343string_Please20input20a20value3A20#

 @9340$main$2:
	; Call 40 printf 0
	mov qword [rbp + 40], @9340$main$3
	mov [rbp + 48], rbp
	add rbp, 40
	mov rdi, rbp
	jmp printf
 ...
 @9340$main$5:
	...
	mov qword [rbp + 64], @9344string_25lf#

 @9340$main$6:
	; Address £temporary4113 x
	mov rsi, rbp
	add rsi, 32

 @9340$main$7:
	; Parameter 72 pointer £temporary4113
	mov [rbp + 72], rsi

 @9340$main$8:
	; Call 40 scanf 8
	mov qword [rbp + 40], @9340$main$9
	mov [rbp + 48], rbp
	add rbp, 40
	mov rdi, rbp
	add rdi, 8
 ...
 @9340$main$15:
	; IntegralToIntegral £temporary4116 £temporary4115
	mov rax, 4294967295
	and rbx, rax

 @9340$main$16:
	; Assign message £temporary4116
	mov [rbp + 24], rbx
 ...
 @9340$main$19:
	...
	mov qword [rbp + 64], @9347string_12E0202F2025f203D2025f0A#
 ...
 @9340$main$28:
	; Parameter 80 double £temporary4118
	fstp qword [rbp + 80]

 @9340$main$29:
	; Call 40 printf 16
	mov qword [rbp + 40], @9340$main$30
	mov [rbp + 48], rbp
	add rbp, 40
	mov rdi, rbp
	add rdi, 16
 ...
 @9340$main$33:
	...
	mov qword [rbp + 64], @9348string_25s0A#
...
@9363string_Division20by20Zero2E#:
...
section .text
 ...
 divide$5:
	; Divide £temporary4131 x y
	fdiv

 divide$6:
	; Return £temporary4131
	mov rax, [rbp]
	mov rdi, [rbp + 16]
	mov rbp, [rbp + 8]
	jmp rax
 ...
 divide$9:
	; IntegralToIntegral £temporary4132 string_Division20by20Zero2E#
	mov rax, @9363string_Division20by20Zero2E#

 divide$10:
	; Parameter 72 signed int £temporary4132
	mov [rbp + 72], eax
...
@9372string_12E0202F2025f203D2025f0A#:
	; Initializer String 1.0 / %f = %f\n
	db "1.0 / %f = %f", 10, 0
...
section .text
 ...
 test$5:
	; IntegralToIntegral £temporary4137 £temporary4136
	mov rax, 4294967295
	and rbx, rax

 test$6:
	; Assign message £temporary4137
	mov [rbp + 32], rbx
 ...
 test$9:
	; Parameter 64 string string_12E0202F2025f203D2025f0A#
	mov qword [rbp + 64], @9372string_12E0202F2025f203D2025f0A#
 ...
 test$18:
	; Parameter 80 double £temporary4139
	fstp qword [rbp + 80]
 ...
 test$23:
	; Parameter 64 string string_25s0A#
	mov qword [rbp + 64], @9373string_25s0A#
