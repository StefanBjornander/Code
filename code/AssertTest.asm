...
section .text
 ...
 assert_test$4:
	; 6 Parameter 60 pointer string_Assertion20failed3A202225s2220in20file2025s20at20line2025i0A#
	mov qword [rbp + 60], @8594string_Assertion20failed3A202225s2220in20file2025s20at20line2025i0A#

 assert_test$5:
	; 7 Parameter 68 pointer string_n203D3D201#
	mov qword [rbp + 68], @8595string_n203D3D201#

 assert_test$6:
	; 8 Parameter 76 pointer string_C3A5CUsers5CStefa5CDocuments5Cvagrant5Chomestead5Ccode5Ccode5CAssertTest2Ec#
...
section .text
 ...
 assert_testX$2:
	; 2 Parameter 52 pointer string_Please20write20a20number2028not20620or207293A20#
 ...
 assert_testX$6:
	; 6 Parameter 52 pointer string_25i#
 ...
 assert_testX$14:
	; 16 Parameter 60 pointer string_Assertion20failed3A202225s2220in20file2025s20at20line2025i0A#
	mov qword [rbp + 60], @8609string_Assertion20failed3A202225s2220in20file2025s20at20line2025i0A#

 assert_testX$15:
	; 17 Parameter 68 pointer string_n20213D206#
	mov qword [rbp + 68], @8610string_n20213D206#

 assert_testX$16:
	; 18 Parameter 76 pointer string_C3A5CUsers5CStefa5CDocuments5Cvagrant5Chomestead5Ccode5Ccode5CAssertTest2Ec#
...
section .text
 ...
 assert_test2$3:
	; 5 Parameter 60 pointer string_Assertion20failed3A202225s2220in20file2025s20at20line2025i0A#
	mov qword [rbp + 60], @8624string_Assertion20failed3A202225s2220in20file2025s20at20line2025i0A#

 assert_test2$4:
	; 6 Parameter 68 pointer string_n20213D207#
	mov qword [rbp + 68], @8625string_n20213D207#

 assert_test2$5:
	; 7 Parameter 76 pointer string_C3A5CUsers5CStefa5CDocuments5Cvagrant5Chomestead5Ccode5Ccode5CAssertTest2Ec#
