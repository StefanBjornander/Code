...
@8866string_Assertion20failed3A202225s2220in20file2025s20at20line2025i0A#:
	; Initializer String Assertion failed: "%s" in file %s at line %i\n
	db "Assertion failed: ", 34, "%s", 34, " in file %s at line %i", 10, 0

section .data

@8867string_n203D3D201#:
	; Initializer String n == 1
	db "n == 1", 0

section .data

@8868string_C3A5CUsers5CStefa5CDocuments5Cvagrant5Chomestead5Ccode5Ccode5CAssertTest2Ec#:
...
@8878string_Please20write20a20number2028not20620or207293A20#:
...
@8881string_Assertion20failed3A202225s2220in20file2025s20at20line2025i0A#:
	; Initializer String Assertion failed: "%s" in file %s at line %i\n
	db "Assertion failed: ", 34, "%s", 34, " in file %s at line %i", 10, 0

section .data

@8882string_n20213D206#:
	; Initializer String n != 6
	db "n != 6", 0

section .data

@8883string_C3A5CUsers5CStefa5CDocuments5Cvagrant5Chomestead5Ccode5Ccode5CAssertTest2Ec#:
	; Initializer String C:\Users\Stefa\Documents\vagrant\homestead\code\code\AssertTest.c
	db "C:\Users\Stefa\Documents\vagrant\homestead\code\code\AssertTest.c", 0
...
@8896string_Assertion20failed3A202225s2220in20file2025s20at20line2025i0A#:
	; Initializer String Assertion failed: "%s" in file %s at line %i\n
	db "Assertion failed: ", 34, "%s", 34, " in file %s at line %i", 10, 0

section .data

@8897string_n20213D207#:
	; Initializer String n != 7
	db "n != 7", 0

section .data

@8898string_C3A5CUsers5CStefa5CDocuments5Cvagrant5Chomestead5Ccode5Ccode5CAssertTest2Ec#:
	; Initializer String C:\Users\Stefa\Documents\vagrant\homestead\code\code\AssertTest.c
	db "C:\Users\Stefa\Documents\vagrant\homestead\code\code\AssertTest.c", 0
