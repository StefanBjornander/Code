...
section .text
 ...
 time_test$14:
	; Address £temporary4928 now1
	mov rsi, rbp
	add rsi, 80

 time_test$15:
	; Parameter 112 pointer £temporary4928
	mov [rbp + 112], rsi
 ...
 time_test$19:
	; Dereference £temporary4930 £temporary4929 0

 time_test$20:
	; AssignInitSize s £temporary4930
	mov rsi, rbp
	add rsi, 88
	mov al, 36

 time_test$21:
	; Assign s £temporary4930
	mov ah, [rbx]
	mov [rsi], ah
	inc rbx
	inc rsi
 ...
 time_test$24:
	; Parameter 148 pointer £temporary4931
	mov [rbp + 148], rsi
 ...
 time_test$28:
	; Dereference £temporary4933 £temporary4932 0

 time_test$29:
	; AssignInitSize t £temporary4933
	mov rsi, rbp
	add rsi, 124
	mov al, 36

 time_test$30:
	; Assign t £temporary4933
	mov ah, [rbx]
	mov [rsi], ah
	inc rbx
	inc rsi
 ...
 time_test$32:
	; Address £temporary4934 s
	mov rsi, rbp
	add rsi, 88

 time_test$33:
	; Parameter 184 pointer £temporary4934
	mov [rbp + 184], rsi
 ...
 time_test$36:
	; GetReturnValue £temporary4935

 time_test$37:
	; Assign now2 £temporary4935
	mov [rbp + 160], rbx
 ...
 time_test$50:
	; Multiply £temporary4938 s.tm_wday integral4$8#
	mov eax, [rbp + 112]
	xor edx, edx
	imul dword [@12795integral4$8#]

 time_test$51:
	; IntegralToIntegral £temporary4939 £temporary4938
	mov rbx, 4294967295
	and rax, rbx

 time_test$52:
	; Add £temporary4940 weekdays £temporary4939
	mov rsi, rbp
	add rsi, 24
	add rsi, rax

 time_test$53:
	; Dereference £temporary4941 £temporary4940 0

 time_test$54:
	; Parameter 200 pointer £temporary4941
	mov rax, [rsi]
	mov [rbp + 200], rax

 time_test$55:
	; Add £temporary4942 s.tm_year integral4$1900#
	mov eax, [rbp + 108]
	add eax, 1900

 time_test$56:
	; Parameter 208 signed int £temporary4942
	mov [rbp + 208], eax

 time_test$57:
	; Add £temporary4943 s.tm_mon integral4$1#
	mov eax, [rbp + 104]
	inc eax

 time_test$58:
	; Parameter 212 signed int £temporary4943
	mov [rbp + 212], eax
 ...
 time_test$70:
	; Multiply £temporary4945 t.tm_wday integral4$8#
	mov eax, [rbp + 148]
	xor edx, edx
	imul dword [@12809integral4$8#]

 time_test$71:
	; IntegralToIntegral £temporary4946 £temporary4945
	mov rbx, 4294967295
	and rax, rbx

 time_test$72:
	; Add £temporary4947 weekdays £temporary4946
	mov rsi, rbp
	add rsi, 24
	add rsi, rax

 time_test$73:
	; Dereference £temporary4948 £temporary4947 0

 time_test$74:
	; Parameter 200 pointer £temporary4948
	mov rax, [rsi]
	mov [rbp + 200], rax

 time_test$75:
	; Add £temporary4949 t.tm_year integral4$1900#
	mov eax, [rbp + 144]
	add eax, 1900

 time_test$76:
	; Parameter 208 signed int £temporary4949
	mov [rbp + 208], eax

 time_test$77:
	; Add £temporary4950 t.tm_mon integral4$1#
	mov eax, [rbp + 140]
	inc eax

 time_test$78:
	; Parameter 212 signed int £temporary4950
	mov [rbp + 212], eax
 ...
 time_test$91:
	; Address £temporary4952 s
	mov rsi, rbp
	add rsi, 88

 time_test$92:
	; Parameter 828 pointer £temporary4952
	mov [rbp + 828], rsi
 ...
 time_test$96:
	; Parameter 804 pointer £temporary4953
	mov [rbp + 804], rbx
 ...
 time_test$102:
	; Address £temporary4955 now1
	mov rsi, rbp
	add rsi, 80

 time_test$103:
	; Parameter 828 pointer £temporary4955
	mov [rbp + 828], rsi
 ...
 time_test$106:
	; GetReturnValue £temporary4956

 time_test$107:
	; Parameter 804 pointer £temporary4956
	mov [rbp + 804], rbx
 ...
 time_test$120:
	; Address £temporary4959 t
	mov rsi, rbp
	add rsi, 124

 time_test$121:
	; Parameter 816 pointer £temporary4959
	mov [rbp + 816], rsi
 ...
 time_test$124:
	; GetReturnValue £temporary4960

 time_test$125:
	; Assign i £temporary4960
	mov [rbp + 768], ebx
 ...
 time_test$133:
	; GetReturnValue £temporary4961

 time_test$134:
	; Parameter 808 signed int £temporary4961
	mov [rbp + 808], ebx
