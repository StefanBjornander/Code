...
@12913string_now2013A2025lu0A#:
	; Initializer String now 1: %lu\n
	db "now 1: %lu", 10, 0

section .data

@12914string_now2023A2025lu0A#:
	; Initializer String now 2: %lu\n
	db "now 2: %lu", 10, 0

section .data

@12915string_202020gm20time3A2025s202502i2D2502i2D2502i202502i3A2502i3A2502i2C20year20day2025i2C20week20day2025i2C20daylight20saving20time2025i0A#:
...
@12929string_local20time3A2025s202502i2D2502i2D2502i202502i3A2502i3A2502i2C20year20day2025i2C20week20day2025i2C20daylight20saving20time2025i0A#:
...
@12953string_asctime203C25s3E2C20ctime203C25s3E0A#:
	; Initializer String asctime <%s>, ctime <%s>\n
	db "asctime <%s>, ctime <%s>", 10, 0

section .data

@12955string_#:
...
@12956string_strftime2025i2025i203C25s3E0A#:
...
section .text
 ...
 time_test:
	...
	mov qword [rbp + 24], @12899string_Sun#

 time_test$1:
	; Assign weekdays[1] string_Mon#
	mov qword [rbp + 32], @12900string_Mon#

 time_test$2:
	; Assign weekdays[2] string_Tue#
	mov qword [rbp + 40], @12901string_Tue#

 time_test$3:
	; Assign weekdays[3] string_Wed#
	mov qword [rbp + 48], @12902string_Wed#

 time_test$4:
	; Assign weekdays[4] string_Thu#
	mov qword [rbp + 56], @12903string_Thu#

 time_test$5:
	; Assign weekdays[5] string_Fri#
	mov qword [rbp + 64], @12904string_Fri#

 time_test$6:
	; Assign weekdays[6] string_Sat#
	mov qword [rbp + 72], @12905string_Sat#
 ...
 time_test$11:
	; GetReturnValue £temporary5149

 time_test$12:
	; Assign now1 £temporary5149
	mov [rbp + 80], rbx
 ...
 time_test$14:
	; Address £temporary5150 now1
	mov rsi, rbp
	add rsi, 80

 time_test$15:
	; Parameter 112 pointer £temporary5150
	mov [rbp + 112], rsi
 ...
 time_test$18:
	; GetReturnValue £temporary5151

 time_test$19:
	; Dereference £temporary5152 £temporary5151 0

 time_test$20:
	; AssignInitSize s £temporary5152
	mov rsi, rbp
	add rsi, 88
	mov al, 36

 time_test$21:
	; Assign s £temporary5152
	mov ah, [rbx]
	mov [rsi], ah
	inc rbx
	inc rsi
 ...
 time_test$23:
	; Address £temporary5153 now1
	mov rsi, rbp
	add rsi, 80

 time_test$24:
	; Parameter 148 pointer £temporary5153
	mov [rbp + 148], rsi
 ...
 time_test$27:
	; GetReturnValue £temporary5154

 time_test$28:
	; Dereference £temporary5155 £temporary5154 0

 time_test$29:
	; AssignInitSize t £temporary5155
	mov rsi, rbp
	add rsi, 124
	mov al, 36

 time_test$30:
	; Assign t £temporary5155
	mov ah, [rbx]
	mov [rsi], ah
	inc rbx
	inc rsi
 ...
 time_test$32:
	; Address £temporary5156 s
	mov rsi, rbp
	add rsi, 88

 time_test$33:
	; Parameter 184 pointer £temporary5156
	mov [rbp + 184], rsi
 ...
 time_test$36:
	; GetReturnValue £temporary5157

 time_test$37:
	; Assign now2 £temporary5157
	mov [rbp + 160], rbx
 ...
 time_test$39:
	...
	mov qword [rbp + 192], @12913string_now2013A2025lu0A#
 ...
 time_test$44:
	...
	mov qword [rbp + 192], @12914string_now2023A2025lu0A#
 ...
 time_test$49:
	...
	mov qword [rbp + 192], @12915string_202020gm20time3A2025s202502i2D2502i2D2502i202502i3A2502i3A2502i2C20year20day2025i2C20week20day2025i2C20daylight20saving20time2025i0A#

 time_test$50:
	; Multiply £temporary5160 s.tm_wday integral4$8#
	mov eax, [rbp + 112]
	xor edx, edx
	imul dword [@12917integral4$8#]

 time_test$51:
	; IntegralToIntegral £temporary5161 £temporary5160
	mov rbx, 4294967295
	and rax, rbx

 time_test$52:
	; Add £temporary5162 weekdays £temporary5161
	mov rsi, rbp
	add rsi, 24
	add rsi, rax

 time_test$53:
	; Dereference £temporary5163 £temporary5162 0

 time_test$54:
	; Parameter 200 pointer £temporary5163
	mov rax, [rsi]
	mov [rbp + 200], rax

 time_test$55:
	; Add £temporary5164 s.tm_year integral4$1900#
	mov eax, [rbp + 108]
	add eax, 1900

 time_test$56:
	; Parameter 208 signed int £temporary5164
	mov [rbp + 208], eax

 time_test$57:
	; Add £temporary5165 s.tm_mon integral4$1#
	mov eax, [rbp + 104]
	inc eax

 time_test$58:
	; Parameter 212 signed int £temporary5165
	mov [rbp + 212], eax
 ...
 time_test$69:
	...
	mov qword [rbp + 192], @12929string_local20time3A2025s202502i2D2502i2D2502i202502i3A2502i3A2502i2C20year20day2025i2C20week20day2025i2C20daylight20saving20time2025i0A#

 time_test$70:
	; Multiply £temporary5167 t.tm_wday integral4$8#
	mov eax, [rbp + 148]
	xor edx, edx
	imul dword [@12931integral4$8#]

 time_test$71:
	; IntegralToIntegral £temporary5168 £temporary5167
	mov rbx, 4294967295
	and rax, rbx

 time_test$72:
	; Add £temporary5169 weekdays £temporary5168
	mov rsi, rbp
	add rsi, 24
	add rsi, rax

 time_test$73:
	; Dereference £temporary5170 £temporary5169 0

 time_test$74:
	; Parameter 200 pointer £temporary5170
	mov rax, [rsi]
	mov [rbp + 200], rax

 time_test$75:
	; Add £temporary5171 t.tm_year integral4$1900#
	mov eax, [rbp + 144]
	add eax, 1900

 time_test$76:
	; Parameter 208 signed int £temporary5171
	mov [rbp + 208], eax

 time_test$77:
	; Add £temporary5172 t.tm_mon integral4$1#
	mov eax, [rbp + 140]
	inc eax

 time_test$78:
	; Parameter 212 signed int £temporary5172
	mov [rbp + 212], eax
 ...
 time_test$91:
	; Address £temporary5174 s
	mov rsi, rbp
	add rsi, 88

 time_test$92:
	; Parameter 828 pointer £temporary5174
	mov [rbp + 828], rsi
 ...
 time_test$95:
	; GetReturnValue £temporary5175

 time_test$96:
	; Parameter 804 pointer £temporary5175
	mov [rbp + 804], rbx
 ...
 time_test$102:
	; Address £temporary5177 now1
	mov rsi, rbp
	add rsi, 80

 time_test$103:
	; Parameter 828 pointer £temporary5177
	mov [rbp + 828], rsi
 ...
 time_test$106:
	; GetReturnValue £temporary5178

 time_test$107:
	; Parameter 804 pointer £temporary5178
	mov [rbp + 804], rbx
 ...
 time_test$111:
	...
	mov qword [rbp + 796], @12953string_asctime203C25s3E2C20ctime203C25s3E0A#
 ...
 time_test$119:
	...
	mov qword [rbp + 808], @12955string_#

 time_test$120:
	; Address £temporary5181 t
	mov rsi, rbp
	add rsi, 124

 time_test$121:
	; Parameter 816 pointer £temporary5181
	mov [rbp + 816], rsi
 ...
 time_test$124:
	; GetReturnValue £temporary5182

 time_test$125:
	; Assign i £temporary5182
	mov [rbp + 768], ebx
 ...
 time_test$127:
	...
	mov qword [rbp + 796], @12956string_strftime2025i2025i203C25s3E0A#
 ...
 time_test$133:
	; GetReturnValue £temporary5183

 time_test$134:
	; Parameter 808 signed int £temporary5183
	mov [rbp + 808], ebx
