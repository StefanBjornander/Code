...
$C:\Users\stefa\Documents\vagrant\homestead\code\code\StdLibTest.c,1$
...
$C:\Users\stefa\Documents\vagrant\homestead\code\code\StdLibTest.c,2$
...
$C:\Users\stefa\Documents\vagrant\homestead\code\code\StdLibTest.c,3$
...
{ int index ;
printf ( "\012\102\040\114\151\163\164\040\064\072\040" ) ;
qsort ( list , size , sizeof list [ 0 ] , compare ) ;
for ( index = 0 ; index < size ; ++ index ) {
printf ( "\045\151\040" , * ( list + index ) ) ;
}
