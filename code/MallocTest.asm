...
section .text
 ...
 malloc_test2$6:
	; GetReturnValue £temporary4824

 malloc_test2$7:
	; Assign q £temporary4824
	mov [rbp + 44], rbx
...
section .text
 ...
 malloc_test3$5:
	; GetReturnValue £temporary4844

 malloc_test3$6:
	; Assign a £temporary4844
	mov [rbp + 24], rbx
 ...
 malloc_test3$12:
	; GetReturnValue £temporary4845

 malloc_test3$13:
	; Assign b £temporary4845
	mov [rbp + 32], rbx
 ...
 malloc_test3$19:
	; GetReturnValue £temporary4846

 malloc_test3$20:
	; Assign c £temporary4846
	mov [rbp + 40], rbx
 ...
 malloc_test3$26:
	; GetReturnValue £temporary4847

 malloc_test3$27:
	; Assign d £temporary4847
	mov [rbp + 48], rbx
 ...
 malloc_test3$33:
	; GetReturnValue £temporary4848

 malloc_test3$34:
	; Assign e £temporary4848
	mov [rbp + 56], rbx
...
@11977string_Stack20Top3A2025u2C20Low20Heap3A2025u0A#:
...
section .text
 ...
 rec$1:
	; InspectRegister £temporary4856 bp

 rec$2:
	; IntegralToIntegral £temporary4857 £temporary4856
	and ebp, 65535

 rec$3:
	; Assign stackTop £temporary4857
	mov [rbp + 24], ebp
 ...
 rec$5:
	...
	mov qword [rbp + 60], @11977string_Stack20Top3A2025u2C20Low20Heap3A2025u0A#
 ...
 rec$7:
	; Dereference £temporary4858 lowHeapPtr 0
	mov rsi, [rbp + 28]

 rec$8:
	; Parameter 72 unsigned int £temporary4858
	mov eax, [rsi]
	mov [rbp + 72], eax
...
section .text
 ...
 malloc_test$4:
	; GetReturnValue £temporary4862

 malloc_test$5:
	; Assign b £temporary4862
	mov [rbp + 24], rbx
 ...
 malloc_test$10:
	; GetReturnValue £temporary4863

 malloc_test$11:
	; Assign c £temporary4863
	mov [rbp + 32], rbx
 ...
 malloc_test$16:
	; GetReturnValue £temporary4864

 malloc_test$17:
	; Assign d £temporary4864
	mov [rbp + 40], rbx
...
@12010string_Index3A2025i2C20Pointer3A2025u2C20Stack20top3A2025u2C20Low20Heap3A2025u0A#:
...
section .text
 ...
 malloc_test6$1:
	; InspectRegister £temporary4874 bp
 ...
 malloc_test6$10:
	; GetReturnValue £temporary4878

 malloc_test6$11:
	; Assign p £temporary4878
	mov [rbp + 40], rbx
 ...
 malloc_test6$13:
	...
	mov qword [rbp + 72], @12010string_Index3A2025i2C20Pointer3A2025u2C20Stack20top3A2025u2C20Low20Heap3A2025u0A#
 ...
 malloc_test6$17:
	; Dereference £temporary4879 lowHeapPtr 0
	mov rsi, [rbp + 32]

 malloc_test6$18:
	; Parameter 96 unsigned int £temporary4879
	mov eax, [rsi]
	mov [rbp + 96], eax
