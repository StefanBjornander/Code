...
section .text
 ...
 malloc_test3$19:
	; GetReturnValue £temporary4743

 malloc_test3$20:
	; Assign c £temporary4743
	mov [rbp + 40], rbx
 ...
 malloc_test3$26:
	; GetReturnValue £temporary4744

 malloc_test3$27:
	; Assign d £temporary4744
	mov [rbp + 48], rbx
...
section .text
 ...
 rec$1:
	; InspectRegister £temporary4753 bp

 rec$2:
	; IntegralToIntegral £temporary4754 £temporary4753
	and ebp, 65535

 rec$3:
	; Assign stackTop £temporary4754
	mov [rbp + 24], ebp
 ...
 rec$8:
	; Parameter 72 unsigned int £temporary4755
	mov eax, [rsi]
	mov [rbp + 72], eax
...
section .text
 ...
 malloc_test$4:
	; GetReturnValue £temporary4759

 malloc_test$5:
	; Assign b £temporary4759
	mov [rbp + 24], rbx
 ...
 malloc_test$10:
	; GetReturnValue £temporary4760

 malloc_test$11:
	; Assign c £temporary4760
	mov [rbp + 32], rbx
 ...
 malloc_test$16:
	; GetReturnValue £temporary4761

 malloc_test$17:
	; Assign d £temporary4761
	mov [rbp + 40], rbx
...
section .text
 ...
 malloc_test6$1:
	; InspectRegister £temporary4771 bp

 malloc_test6$2:
	; IntegralToIntegral £temporary4772 £temporary4771
	and ebp, 65535

 malloc_test6$3:
	; Assign stackTop £temporary4772
	mov [rbp + 28], ebp
 ...
 malloc_test6$10:
	; GetReturnValue £temporary4775

 malloc_test6$11:
	; Assign p £temporary4775
	mov [rbp + 40], rbx
 ...
 malloc_test6$17:
	; Dereference £temporary4776 lowHeapPtr 0
	mov rsi, [rbp + 32]

 malloc_test6$18:
	; Parameter 96 unsigned int £temporary4776
	mov eax, [rsi]
	mov [rbp + 96], eax
