...
section .text
 ...
 generateName:
	; Add £temporary1083 index integral4$1#
	mov eax, [rbp + 24]
	inc eax

 generateName$1:
	; GreaterThanEqual 31 £temporary1083 max
	cmp eax, [rbp + 36]
	jge generateName$31

 generateName$2:
	; Add £temporary1086 index integral4$1#
	mov eax, [rbp + 24]
	inc eax
 ...
 generateName$4:
	; Add £temporary1088 name £temporary1087
	mov rsi, [rbp + 28]
	add rsi, rax

 generateName$5:
	; Dereference £temporary1089 £temporary1088 0

 generateName$6:
	; Assign £temporary1089 integral1$0#
	mov byte [rsi], 0
 ...
 generateName$9:
	; IntegralToIntegral £temporary1093 index
	mov eax, [rbp + 24]
	mov rbx, 4294967295
	and rax, rbx

 generateName$10:
	; Add £temporary1094 name £temporary1093
	mov rsi, [rbp + 28]
	add rsi, rax

 generateName$11:
	; Dereference £temporary1095 £temporary1094 0

 generateName$12:
	; Assign £temporary1095 c
	mov al, [rbp + 40]
	mov [rsi], al
 ...
 generateName$18:
	; Equal 28 £temporary1096 integral4$0#
	cmp ebx, 0
	je generateName$28
 ...
 generateName$21:
	; Parameter 65 signed int £temporary1099
	mov [rbp + 65], eax
 ...
 generateName$27:
	; Equal 29 £temporary1100 integral4$0#
	cmp ebx, 0
	je generateName$29
 ...
 generateName$32:
	; IntegralToIntegral £temporary1107 index
	mov eax, [rbp + 24]
	mov rbx, 4294967295
	and rax, rbx

 generateName$33:
	; Add £temporary1108 name £temporary1107
	mov rsi, [rbp + 28]
	add rsi, rax

 generateName$34:
	; Dereference £temporary1109 £temporary1108 0

 generateName$35:
	; Assign £temporary1109 integral1$0#
	mov byte [rsi], 0
...
section .text
 ...
 tmpnam$7:
	; Equal 9 £temporary1114 integral4$0#
	cmp ebx, 0
	je tmpnam$9
...
section .text
 ...
 tmpfile$7:
	; Equal 19 £temporary1118 integral4$0#
	cmp ebx, 0
	je tmpfile$19
 ...
 tmpfile$16:
	; Dereference £temporary1123 stream 0
	mov rsi, [rbp + 24]

 tmpfile$17:
	; Assign £temporary1123.temporary integral4$1#
	mov dword [rsi + 37], 1
