...
@11603string_Floating20point20error3A2025i0A#:
...
section .text
 ...
 floating_point_error$1:
	...
	mov qword [rbp + 52], @11603string_Floating20point20error3A2025i0A#
...
section .text
 ...
 exit_handle1$1:
	...
	mov qword [rbp + 48], @11607string_exit10A#
...
section .text
 ...
 exit_handle2$1:
	...
	mov qword [rbp + 48], @11610string_exit20A#
...
section .text
 ...
 exit_handle3$1:
	...
	mov qword [rbp + 48], @11613string_exit30A#
...
section .text
 ...
 signal_test$4:
	...
	mov qword [rbp + 60], @11621string_25i0A#
