...
$C:\Users\Stefa\Documents\vagrant\homestead\code\code\FileTest.c,0$
...
if ( ! ( inFilePtr != ( ( void * ) 0 )  ) ) { fprintf ( stderr , "Assertion failed: \"%s\" in file %s at line %i\n" , "inFilePtr != NULL" , "C:\\Users\\Stefa\\Documents\\vagrant\\homestead\\code\\code\\FileTest.c" , 14 ) ; abort ( ) ; }  ;
if ( ! ( outFilePtr != ( ( void * ) 0 )  ) ) { fprintf ( stderr , "Assertion failed: \"%s\" in file %s at line %i\n" , "outFilePtr != NULL" , "C:\\Users\\Stefa\\Documents\\vagrant\\homestead\\code\\code\\FileTest.c" , 15 ) ; abort ( ) ; }  ;
...
if ( ! ( inFilePtr != ( ( void * ) 0 )  ) ) { fprintf ( stderr , "Assertion failed: \"%s\" in file %s at line %i\n" , "inFilePtr != NULL" , "C:\\Users\\Stefa\\Documents\\vagrant\\homestead\\code\\code\\FileTest.c" , 34 ) ; abort ( ) ; }  ;
if ( ! ( outFilePtr != ( ( void * ) 0 )  ) ) { fprintf ( stderr , "Assertion failed: \"%s\" in file %s at line %i\n" , "outFilePtr != NULL" , "C:\\Users\\Stefa\\Documents\\vagrant\\homestead\\code\\code\\FileTest.c" , 35 ) ; abort ( ) ; }  ;
...
if ( ! ( inFilePtr != ( ( void * ) 0 )  ) ) { fprintf ( stderr , "Assertion failed: \"%s\" in file %s at line %i\n" , "inFilePtr != NULL" , "C:\\Users\\Stefa\\Documents\\vagrant\\homestead\\code\\code\\FileTest.c" , 119 ) ; abort ( ) ; }  ;
...
if ( ! ( outFilePtr != ( ( void * ) 0 )  ) ) { fprintf ( stderr , "Assertion failed: \"%s\" in file %s at line %i\n" , "outFilePtr != NULL" , "C:\\Users\\Stefa\\Documents\\vagrant\\homestead\\code\\code\\FileTest.c" , 171 ) ; abort ( ) ; }  ;
...
if ( ! ( inFilePtr != ( ( void * ) 0 )  ) ) { fprintf ( stderr , "Assertion failed: \"%s\" in file %s at line %i\n" , "inFilePtr != NULL" , "C:\\Users\\Stefa\\Documents\\vagrant\\homestead\\code\\code\\FileTest.c" , 188 ) ; abort ( ) ; }  ;
...
if ( ! ( outFilePtr != ( ( void * ) 0 )  ) ) { fprintf ( stderr , "Assertion failed: \"%s\" in file %s at line %i\n" , "outFilePtr != NULL" , "C:\\Users\\Stefa\\Documents\\vagrant\\homestead\\code\\code\\FileTest.c" , 203 ) ; abort ( ) ; }  ;
...
if ( ! ( inFilePtr != ( ( void * ) 0 )  ) ) { fprintf ( stderr , "Assertion failed: \"%s\" in file %s at line %i\n" , "inFilePtr != NULL" , "C:\\Users\\Stefa\\Documents\\vagrant\\homestead\\code\\code\\FileTest.c" , 217 ) ; abort ( ) ; }  ;
...
{ FILE * inFilePtr = fopen ( "TestY.bin" , "r" ) ;
if ( ! ( inFilePtr != ( ( void * ) 0 )  ) ) { fprintf ( stderr , "Assertion failed: \"%s\" in file %s at line %i\n" , "inFilePtr != NULL" , "C:\\Users\\Stefa\\Documents\\vagrant\\homestead\\code\\code\\FileTest.c" , 232 ) ; abort ( ) ; }  ;
...
if ( ! ( inFilePtr != ( ( void * ) 0 )  ) ) { fprintf ( stderr , "Assertion failed: \"%s\" in file %s at line %i\n" , "inFilePtr != NULL" , "C:\\Users\\Stefa\\Documents\\vagrant\\homestead\\code\\code\\FileTest.c" , 250 ) ; abort ( ) ; }  ;
fread ( & size , sizeof size , 1 , inFilePtr ) ;
...
if ( ! ( p != ( ( void * ) 0 )  ) ) { fprintf ( stderr , "Assertion failed: \"%s\" in file %s at line %i\n" , "p != NULL" , "C:\\Users\\Stefa\\Documents\\vagrant\\homestead\\code\\code\\FileTest.c" , 257 ) ; abort ( ) ; }  ;
...
if ( ! ( outFilePtr != ( ( void * ) 0 )  ) ) { fprintf ( stderr , "Assertion failed: \"%s\" in file %s at line %i\n" , "outFilePtr != NULL" , "C:\\Users\\Stefa\\Documents\\vagrant\\homestead\\code\\code\\FileTest.c" , 284 ) ; abort ( ) ; }  ;
if ( ! ( inFilePtr != ( ( void * ) 0 )  ) ) { fprintf ( stderr , "Assertion failed: \"%s\" in file %s at line %i\n" , "inFilePtr != NULL" , "C:\\Users\\Stefa\\Documents\\vagrant\\homestead\\code\\code\\FileTest.c" , 285 ) ; abort ( ) ; }  ;
...
if ( ! ( inFilePtr != ( ( void * ) 0 )  ) ) { fprintf ( stderr , "Assertion failed: \"%s\" in file %s at line %i\n" , "inFilePtr != NULL" , "C:\\Users\\Stefa\\Documents\\vagrant\\homestead\\code\\code\\FileTest.c" , 301 ) ; abort ( ) ; }  ;
...
if ( ! ( inOutFilePtr != ( ( void * ) 0 )  ) ) { fprintf ( stderr , "Assertion failed: \"%s\" in file %s at line %i\n" , "inOutFilePtr != NULL" , "C:\\Users\\Stefa\\Documents\\vagrant\\homestead\\code\\code\\FileTest.c" , 369 ) ; abort ( ) ; }  ;
printf ( "Temp\n" ) ;
tempFilePtr = tmpfile ( ) ;
if ( ! ( tempFilePtr != ( ( void * ) 0 )  ) ) { fprintf ( stderr , "Assertion failed: \"%s\" in file %s at line %i\n" , "tempFilePtr != NULL" , "C:\\Users\\Stefa\\Documents\\vagrant\\homestead\\code\\code\\FileTest.c" , 372 ) ; abort ( ) ; }  ;
