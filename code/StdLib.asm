...
section .text
 ...
 strtol_test$22:
	...
	mov qword [rbp + 79], {operand2}

 strtol_test$23:
	; Parameter 87 array text
	mov [rbp + 87], {operand2}
	add qword [rbp + 87], {operand2}
 ...
 strtol_test$25:
	...
	mov rax, [{operand1}{WithSign(operand2)}]
	mov [rbp + 103], {operand2}

 strtol_test$26:
	; Parameter 111 signed int base
	mov eax, [{operand1}{WithSign(operand2)}]
	mov [rbp + 111], {operand2}
 ...
 strtol_test$83:
	...
	mov qword [rbp + 81], {operand2}

 strtol_test$84:
	; Parameter 89 array text
	mov [rbp + 89], {operand2}
	add qword [rbp + 89], {operand2}
