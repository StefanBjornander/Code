...
section .text
 ...
 stdio_test$1:
	; Address £temporary4595 n
	mov rsi, rbp
	add rsi, 24

 stdio_test$2:
	; Assign p £temporary4595
	mov [rbp + 28], rsi
 ...
 stdio_test$338:
	; Address £temporary4625 a
	mov rsi, rbp
	add rsi, 24

 stdio_test$339:
	; Parameter 76 pointer £temporary4625
	mov [rbp + 76], rsi

 stdio_test$340:
	; Address £temporary4626 b
	mov rsi, rbp
	add rsi, 28

 stdio_test$341:
	; Parameter 84 pointer £temporary4626
	mov [rbp + 84], rsi

 stdio_test$342:
	; Address £temporary4627 n
	mov rsi, rbp
	add rsi, 32

 stdio_test$343:
	; Parameter 92 pointer £temporary4627
	mov [rbp + 92], rsi
