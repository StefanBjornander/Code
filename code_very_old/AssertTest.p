...
$C:\Users\Stefa\Documents\vagrant\homestead\code\code\AssertTest.c,0$
...
int n = 1 ;
if ( ! ( n == 1 ) ) { fprintf ( stderr , "Assertion failed: \"%s\" in file %s at line %i\n" , "n == 1" , "C:\\Users\\Stefa\\Documents\\vagrant\\homestead\\code\\code\\AssertTest.c" , 8 ) ; abort ( ) ; }  ;
...
scanf ( "%i" , & n ) ;
if ( ! ( n != 6 ) ) { fprintf ( stderr , "Assertion failed: \"%s\" in file %s at line %i\n" , "n != 6" , "C:\\Users\\Stefa\\Documents\\vagrant\\homestead\\code\\code\\AssertTest.c" , 16 ) ; abort ( ) ; }  ;
assert_test2 ( n ) ;
}

void assert_test2 ( int n ) {
if ( ! ( n != 7 ) ) { fprintf ( stderr , "Assertion failed: \"%s\" in file %s at line %i\n" , "n != 7" , "C:\\Users\\Stefa\\Documents\\vagrant\\homestead\\code\\code\\AssertTest.c" , 21 ) ; abort ( ) ; }  ;
} 
