...
section .text
 ...
 stack_test$4:
	; Parameter 56 signed int £temporary4690
	mov [rbp + 56], eax
...
section .text
 ...
 heap_test$12:
	; Parameter 68 signed int £temporary4696
	mov [rbp + 68], eax
