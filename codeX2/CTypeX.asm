...
section .text
 ...
 tolower$5:
	; Equal 33 £temporary261 integral4$0#
	cmp ebx, 0
	je tolower$33
 ...
 tolower$25:
	; Assign £temporary269 index
	mov eax, [rbp + 52]

 tolower$26:
	; IntegralToIntegral £temporary270 £temporary269
	mov rbx, 4294967295
	and rax, rbx
...
section .text
 ...
 toupper$5:
	; Equal 33 £temporary280 integral4$0#
	cmp ebx, 0
	je toupper$33
 ...
 toupper$25:
	; Assign £temporary288 index
	mov eax, [rbp + 52]

 toupper$26:
	; IntegralToIntegral £temporary289 £temporary288
	mov rbx, 4294967295
	and rax, rbx

 toupper$27:
	; Add £temporary290 upperCase £temporary289
	mov rsi, [rbp + 44]
	add rsi, rax

 toupper$28:
	; Dereference £temporary291 £temporary290 0

 toupper$29:
	; IntegralToIntegral £temporary292 £temporary291
	mov bl, [rsi]
	and ebx, 255
	cmp bl, 0
	jge toupper$30
 ...
 toupper$31:
	; Subtract £temporary293 c integral4$32#
	mov ebx, [rbp + 24]
	sub ebx, 32
