...
@8835string_Hello2C20World21#:
	; Initializer String Hello, World!
	db "Hello, World!", 0

section .data

@8844string_strlen282225s2229203D2025i0A#:
	; Initializer String strlen("%s") = %i\n
	db "strlen(", 34, "%s", 34, ") = %i", 10, 0

section .data

@8849string_t203D202225s222C20u203D202225s220A#:
...
@8934string_strtok28s2C20222C2229203D202225s220A#:
...
section .text
 ...
 string_test:
	...
	mov qword [rbp + 28], @8835string_Hello2C20World21#
 ...
 string_test$2:
	...
	mov qword [rbp + 268], @8844string_strlen282225s2229203D2025i0A#
 ...
 string_test$9:
	; Parameter 284 signed int £temporary3915
	mov [rbp + 284], ebx
 ...
 string_test$23:
	; Dereference £temporary3920 £temporary3919 0
	mov rsi, rbp
	add rsi, 136

 string_test$24:
	; Assign £temporary3920 integral1$0#
	mov byte [rsi + 5], 0
 ...
 string_test$26:
	...
	mov qword [rbp + 268], @8849string_t203D202225s222C20u203D202225s220A#
 ...
 string_test$33:
	...
	mov qword [rbp + 276], @8850string_abc#
 ...
 string_test$44:
	; Parameter 276 string string_abc#
	mov qword [rbp + 276], @8851string_abc#
 ...
 string_test$48:
	; Add £temporary3925 i integral4$2#
	mov eax, [rbp + 24]
	add eax, 2

 string_test$49:
	; IntegralToIntegral £temporary3926 £temporary3925
	mov rbx, 4294967295
	and rax, rbx

 string_test$50:
	; Add £temporary3927 u £temporary3926
	mov rsi, rbp
	add rsi, 136
	add rsi, rax

 string_test$51:
	; Dereference £temporary3928 £temporary3927 0

 string_test$52:
	; Assign £temporary3928 integral1$0#
	mov byte [rsi], 0
 ...
 string_test$54:
	; Parameter 268 string string_t203D202225s222C20u203D202225s220A#
	mov qword [rbp + 268], @8855string_t203D202225s222C20u203D202225s220A#
 ...
 string_test$60:
	...
	mov qword [rbp + 268], @8856string_strcmp28s2C20u29203D2025i0A#
 ...
 string_test$67:
	; Parameter 276 signed int £temporary3930
	mov [rbp + 276], ebx
 ...
 string_test$71:
	...
	mov qword [rbp + 268], @8857string_strncmp28s2C20u2C20229203D2025i0A#
 ...
 string_test$79:
	; Parameter 276 signed int £temporary3932
	mov [rbp + 276], ebx
 ...
 string_test$90:
	...
	mov qword [rbp + 268], @8861string_strchr28s2C2027l2729203D2025i0A#
 ...
 string_test$92:
	; Subtract £temporary3936 p s
	mov rax, [rbp + 236]
	sub rax, [rbp + 28]

 string_test$93:
	; IntegralToIntegral £temporary3938 £temporary3936
 ...
 string_test$95:
	; Assign £temporary3938 integral4$minus1#
	mov eax, -1

 string_test$96:
	; Parameter 276 signed int £temporary3938
	mov [rbp + 276], eax
 ...
 string_test$107:
	...
	mov qword [rbp + 268], @8867string_strrchr28s2C2027l2729203D2025i0A#
 ...
 string_test$109:
	; Subtract £temporary3942 p s
	mov rax, [rbp + 236]
	sub rax, [rbp + 28]

 string_test$110:
	; IntegralToIntegral £temporary3944 £temporary3942
 ...
 string_test$112:
	; Assign £temporary3944 integral4$minus1#
	mov eax, -1

 string_test$113:
	; Parameter 276 signed int £temporary3944
	mov [rbp + 276], eax
 ...
 string_test$124:
	...
	mov qword [rbp + 268], @8873string_strchr28s2C2027x2729203D2025i0A#
 ...
 string_test$126:
	; Subtract £temporary3948 p s
	mov rax, [rbp + 236]
	sub rax, [rbp + 28]

 string_test$127:
	; IntegralToIntegral £temporary3950 £temporary3948
 ...
 string_test$129:
	; Assign £temporary3950 integral4$minus1#
	mov eax, -1

 string_test$130:
	; Parameter 276 signed int £temporary3950
	mov [rbp + 276], eax
 ...
 string_test$141:
	...
	mov qword [rbp + 268], @8879string_strrchr28s2C2027x2729203D2025i0A#
 ...
 string_test$143:
	; Subtract £temporary3954 p s
	mov rax, [rbp + 236]
	sub rax, [rbp + 28]

 string_test$144:
	; IntegralToIntegral £temporary3956 £temporary3954
 ...
 string_test$146:
	; Assign £temporary3956 integral4$minus1#
	mov eax, -1

 string_test$147:
	; Parameter 276 signed int £temporary3956
	mov [rbp + 276], eax
 ...
 string_test$152:
	...
	mov qword [rbp + 276], @8883string_Hello2C20World21#
 ...
 string_test$158:
	; Parameter 276 string string_Hello2C20World21#
	mov qword [rbp + 276], @8887string_Hello2C20World21#
 ...
 string_test$168:
	; Dereference £temporary3962 £temporary3961 0
	mov rsi, rbp
	add rsi, 136

 string_test$169:
	; Assign £temporary3962 integral1$0#
	mov byte [rsi + 19], 0
 ...
 string_test$171:
	...
	mov qword [rbp + 268], @8901string_s203D202225s222C20t203D202225s222C20u203D202225s220A#
 ...
 string_test$186:
	...
	mov qword [rbp + 268], @8907string_memchr28s2C2027l272C20SIZE202A20sizeof28char2929203D2025i0A#
 ...
 string_test$188:
	; Subtract £temporary3966 p s
	mov rax, [rbp + 236]
	sub rax, [rbp + 28]

 string_test$189:
	; IntegralToIntegral £temporary3968 £temporary3966
 ...
 string_test$191:
	; Assign £temporary3968 integral4$minus1#
	mov eax, -1

 string_test$192:
	; Parameter 276 signed int £temporary3968
	mov [rbp + 276], eax
 ...
 string_test$201:
	; GetReturnValue £temporary3970

 string_test$202:
	; Assign p £temporary3970
	mov [rbp + 236], rbx
 ...
 string_test$204:
	...
	mov qword [rbp + 268], @8916string_memchr28s2C2027x272C20SIZE202A20sizeof28char2929203D2025i0A#
 ...
 string_test$206:
	; Subtract £temporary3972 p s
	mov rax, [rbp + 236]
	sub rax, [rbp + 28]

 string_test$207:
	; IntegralToIntegral £temporary3974 £temporary3972
 ...
 string_test$209:
	; Assign £temporary3974 integral4$minus1#
	mov eax, -1

 string_test$210:
	; Parameter 276 signed int £temporary3974
	mov [rbp + 276], eax
 ...
 string_test$214:
	...
	mov qword [rbp + 268], @8920string_s3A202225s222C20t3A202225s220A#
 ...
 string_test$220:
	...
	mov qword [rbp + 268], @8921string_strcmp28s2C20t29203D2025i0A#
 ...
 string_test$227:
	; Parameter 276 signed int £temporary3977
	mov [rbp + 276], ebx
 ...
 string_test$231:
	...
	mov qword [rbp + 268], @8922string_memcmp28s2C20t2C20SIZE202A20sizeof28char2929203D2025i0A#
 ...
 string_test$239:
	; Parameter 276 signed int £temporary3979
	mov [rbp + 276], ebx
 ...
 string_test$243:
	...
	mov qword [rbp + 268], @8926string_strspn28s2C2022Hello2C20C2229203D2025i0A#
 ...
 string_test$246:
	...
	mov qword [rbp + 308], @8927string_Hello2C20C#
 ...
 string_test$250:
	; Parameter 276 signed int £temporary3981
	mov [rbp + 276], ebx
 ...
 string_test$254:
	...
	mov qword [rbp + 268], @8928string_strcspn28s2C2022Hello2C20C2229203D2025i0A#
 ...
 string_test$257:
	; Parameter 308 string string_Hello2C20C#
	mov qword [rbp + 308], @8929string_Hello2C20C#
 ...
 string_test$260:
	; GetReturnValue £temporary3983

 string_test$261:
	; Parameter 276 signed int £temporary3983
	mov [rbp + 276], ebx
 ...
 string_test$265:
	...
	mov qword [rbp + 268], @8930string_strerror28errno29203D202225s220A#
 ...
 string_test$271:
	; Parameter 276 pointer £temporary3985
	mov [rbp + 276], rbx
 ...
 string_test$276:
	...
	mov qword [rbp + 276], @8931string_2C#
 ...
 string_test$283:
	...
	mov qword [rbp + 268], @8934string_strtok28s2C20222C2229203D202225s220A#
 ...
 string_test$289:
	; Parameter 276 string string_2C#
	mov qword [rbp + 276], @8937string_2C#
 ...
 string_test$292:
	; GetReturnValue £temporary3990

 string_test$293:
	; Assign p £temporary3990
	mov [rbp + 236], rbx
